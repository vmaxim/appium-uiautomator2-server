...
public abstract class SafeRequestHandler extends BaseRequestHandler {
    ...
    protected String getIdOfKnownElement(IHttpRequest request, ManagedAndroidElement element) {
        return KnownElements.getIdOfElement(element);
    }

    protected ManagedAndroidElement getElementFromCache(IHttpRequest request, String id) {
