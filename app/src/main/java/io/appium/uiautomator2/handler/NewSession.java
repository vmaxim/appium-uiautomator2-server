...
public class NewSession extends SafeRequestHandler {
    ...
    protected AppiumResponse safeHandle(IHttpRequest request) throws JSONException {
        final Map<String, Object> capabilities = getPayload(request, "desiredCapabilities");
        String sessionID = AppiumUiAutomatorDriver.getInstance().initializeSession(capabilities);
