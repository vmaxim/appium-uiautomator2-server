...
public class ServerInstrumentation {
    ...
    public void startServer() throws InterruptedException {
        ...
        if (serverThread != null) {
            Log.e("Stopping selendroid io.appium.uiautomator2.http io.appium.uiautomator2.server");
            stopServer();
        }
        ...
        Log.i("==========================io.appium.uiautomator2.server started:");
    }
    ...
    private void stopServerThread() {
        ...
        Log.e("Stopping uiautomator2 io.appium.uiautomator2.http io.appium.uiautomator2.server");
    ...
    private class HttpdThread extends Thread {
        ...
        private void startServer() {
            try {
                ...
                Log.i("Started selendroid io.appium.uiautomator2.http io.appium.uiautomator2.server on port " + server.getPort());
            } catch (Exception e) {
